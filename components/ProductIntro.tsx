...
export const ProductIntro: FC = () => {
  return (
    <div className="leading-none">
      <div className="bg-[rgb(242_244_245/0.32)]  pt-[120px] pb-[100px]">
        <SectionHeader
          h1={'製品紹介'}
          h2={'Checks for Business 製品紹介'}
          h3={'NFT 会員カード取引の各ステップを統合することで、チェックスは経済データエンジンを創り出しました。'}
        />
        <div className="max-w-[702px] w-[70%] mx-auto relative">
          <Image src={illustration_3} alt="card_grid_pc@3x.png" className="" />
          SectionHeader
        </div>
      </div>
      <div className="bg-white flex justify-between flex-wrap px-[80px] py-[160px]">
        <FeatureBullet
          icon={creditcardIcon}
          title="NFT会員カードシステム"
...
const FeatureBullet: FC<FeatureBulletProps> = ({ icon, title, description }) => {
  return (
    <div className="w-[30%]">
